...
<body>
	<div class="container" style="width: 70%; height: 100%;">
		...
		<div class="text-right" style="margin-right: 0px">
			<a href="./list" class="btn peach-gradient btn-sm">All</a>
			<a href="./listDay" class="btn peach-gradient btn-sm">낮잠</a>
			<a href="./listNight" class="btn peach-gradient btn-sm">밤잠</a>
		</div>
